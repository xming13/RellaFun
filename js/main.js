        ...
        onKeyDown: function(event) {
            ...
            switch (String.fromCharCode(event.which)) {
                ...
                case 'X':
                    ...
                    break;
                case 'T':
                    isRotateModeOn ? $('#rotate-mode-off').click() : $('#rotate-mode-on').click();
                    break;
                case 'R':
                    isRainModeOn ? $('#rain-mode-off').click() : $('#rain-mode-on').click();
                    break;
                case 'G':
                    isSoundModeOn ? $('#sound-mode-off').click() : $('#sound-mode-on').click();
                    break;
                case 'C':
                    rellaBoxSize += 1;
                    reloadRella();
